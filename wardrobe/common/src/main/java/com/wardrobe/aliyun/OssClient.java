...
public class OssClient {
    ...
    public static void downOssYsUploadImgs(String imgs) throws Exception{
        ...
        /*FileUtils.copyInputStreamToFile(objectContent, new File("D://123.jpg"));*/
            ...
            putInputStream(objectContent, objectName.substring(0, suffix) + IPlatformConstant.YS_IMG_SUFFIX + IPlatformConstant.OG_IMG_SUFFIX + objectName.substring(suffix));
