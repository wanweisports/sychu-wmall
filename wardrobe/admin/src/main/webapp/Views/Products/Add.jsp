                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 material-list">
                                        <c:forEach var="m" items="${materialList}">
                                            <button type="button" class="btn btn-secondary material-item" data-id="${m.dictId}">${m.dictValue}</button>
                                        </c:forEach>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="p_colorName" placeholder="请输入商品颜色" name="colorName"
                                               data-val="true" data-val-required="请至少输入一种商品颜色" autocomplete="off">
